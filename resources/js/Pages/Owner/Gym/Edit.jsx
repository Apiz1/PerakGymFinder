            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-slate-400 text-sm max-w-2xl mx-auto">
                        Update your gym details to keep your listing accurate and engaging for potential members.
                    </p>
                </div>
                ...
                <div className={`mb-6 p-4 rounded-xl border ${statusConfig.color} bg-opacity-5 flex items-start gap-3`}>
                    ...
                    <div>
                        ...
                        <p className="text-xs text-slate-400 mt-0.5">
                            {gym?.status === 'approved' 
                                ? 'Your gym is live and visible to the public.'
                                : gym?.status === 'pending'
                                    ? 'Your gym is pending admin approval. You can still edit the details.'
                                    : 'Your gym is not currently visible to the public.'}
                        </p>
                    </div>
                </div>
                ...
                <div className="mt-8 glass-card rounded-2xl p-6 backdrop-blur-xl bg-white/5 border-white/10">
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            <h3 className="text-sm font-bold text-white">Tips for a great listing</h3>
                            <ul className="mt-2 space-y-1 text-xs text-slate-400">
                                <li className="flex items-start gap-2">
                                    <span className="text-amber-400">•</span>
                                    <span>Keep your description engaging and up-to-date</span>
                                </li>
                                <li className="flex items-start gap-2">
                                    <span className="text-amber-400">•</span>
                                    <span>Ensure your contact information is correct</span>
                                </li>
                                <li className="flex items-start gap-2">
                                    <span className="text-amber-400">•</span>
                                    <span>Select all facilities and categories that apply</span>
                                </li>
                                <li className="flex items-start gap-2">
                                    <span className="text-amber-400">•</span>
                                    <span>Add high-quality photos from your gym dashboard</span>
                                </li>
                            </ul>
                        </div>
                    </div>
