...
export default function Register() {
    ...
    const submit = (event) => {
        ...
        if (turnstileEnabled && !turnstileVerified) { alert('Please complete the security verification.'); return; }
